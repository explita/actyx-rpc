...
To consume procedures directly inside React components with zero-boilerplate hooks, automatic caching, optimistic updates, and infinite scrolling, install the dedicated React package:
