...
export default function PaginationDemo() {
  const { data, hasNext, fetchNext, isFetching, error, isError } = useInfiniteQuery(
    getPosts,
    {
    ...
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="mt-2 text-gray-600">
          Fetching posts using <code>useInfiniteQuery</code> and cursor-based pagination.
        </p>
      </div>
      ...
      <div className="mt-8 flex justify-center">
        {hasNext ? (
          ...
          <p className="text-gray-500 text-sm">You have reached the end of the internet.</p>
        )}
      </div>
    </div>
  );
